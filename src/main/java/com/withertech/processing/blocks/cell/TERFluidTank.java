...
public class TERFluidTank extends TileEntityRenderer<TileFluidTank>
{

	public static final float TANK_THICKNESS = 0.0625f;

	public TERFluidTank(TileEntityRendererDispatcher dispatcher)
	{
		super(dispatcher);
	}

	@Override
	public void render(@Nonnull TileFluidTank tileEntityIn, float partialTicks, @Nonnull MatrixStack matrixStackIn, @Nonnull IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
	{
	...
	private void renderFluid(@Nonnull TileFluidTank tileEntity, MatrixStack matrix, IRenderTypeBuffer bufferIn)
	{
