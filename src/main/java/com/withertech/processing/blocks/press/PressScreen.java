...
public class PressScreen extends AbstractMachineScreen<PressContainer>
{
	public static final ResourceLocation JEI_TEXTURE = Processing.getId("textures/gui/press.png");
	public final ResourceLocation TEXTURE;

	public PressScreen(PressContainer containerIn, PlayerInventory playerInventoryIn, ITextComponent titleIn)
	{
