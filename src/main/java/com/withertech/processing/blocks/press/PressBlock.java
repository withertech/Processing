...
public class PressBlock extends AbstractFactoryMachineBlock
{
	...
	protected void interactWith(World worldIn, @Nonnull BlockPos pos, @Nonnull PlayerEntity player)
	{
		...
		if (tileentity instanceof PressTile && !player.getHeldItemMainhand().isItemEqual(ModItems.WRENCH.get().getDefaultInstance()))
		{
