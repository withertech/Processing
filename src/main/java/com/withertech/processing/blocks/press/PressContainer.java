...
public class PressContainer extends AbstractMachineContainer<PressTile>
{
	public PressContainer(int id, PlayerInventory playerInventory, MachineTier tier)
	{
		this(id, playerInventory, MachineType.PRESS.create(tier), new IntArray(AbstractMachineTileEntity.FIELDS_COUNT));
	}

	public PressContainer(int id, PlayerInventory playerInventory, PressTile tileEntity, IIntArray fieldsIn)
	{
