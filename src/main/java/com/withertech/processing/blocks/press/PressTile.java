...
public class PressTile extends AbstractMachineTileEntity<RecipePressing> implements IAnimatable, IRestorableTileEntity
{
	// Energy constant
	...
	public PressTile(MachineTier tier)
	{
	...
	private <E extends TileEntity & IAnimatable> PlayState predicate(AnimationEvent<E> event)
	{
		...
		if (event.getAnimatable().getBlockState().get(PressBlock.LIT))
		{
	...
	{
		return new PressContainer(id, playerInventory, this, this.fields);
	}
	...
	public static class Basic extends PressTile
	{
		public Basic()
		{
	...
	public static class Advanced extends PressTile
	{
		public Advanced()
		{
	...
	public static class Elite extends PressTile
	{
		public Elite()
		{
	...
	public static class Ultimate extends PressTile
	{
		public Ultimate()
		{
