...
public class FurnaceBlock extends AbstractFactoryMachineBlock
{
	...
	protected void interactWith(World worldIn, @Nonnull BlockPos pos, @Nonnull PlayerEntity player)
	{
		...
		if (tileEntity instanceof FurnaceTile && !player.getHeldItemMainhand().isItemEqual(ModItems.WRENCH.get().getDefaultInstance()))
		{
	...
	{
		return MachineType.FURNACE.getTileEntityType(tier).create();
	}
