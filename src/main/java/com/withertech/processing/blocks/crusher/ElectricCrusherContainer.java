...
public class ElectricCrusherContainer extends AbstractMachineContainer<ElectricCrusherTile>
{
	public ElectricCrusherContainer(int id, PlayerInventory playerInventory, MachineTier tier)
	{
		this(id, playerInventory, MachineType.CRUSHER.create(tier), new IntArray(AbstractMachineTileEntity.FIELDS_COUNT));
	}

	public ElectricCrusherContainer(int id, PlayerInventory playerInventory, ElectricCrusherTile tileEntity, IIntArray fieldsIn)
	{
