...
public class CrusherTile extends AbstractMachineTileEntity<RecipeCrushing> implements IAnimatable, IRestorableTileEntity
{
	// Energy constant
	...
	public CrusherTile(MachineTier tier)
	{
	...
	private <E extends TileEntity & IAnimatable> PlayState predicate(AnimationEvent<E> event)
	{
		...
		if (event.getAnimatable().getBlockState().get(CrusherBlock.LIT))
		{
	...
	public static class Basic extends CrusherTile
	{
		public Basic()
		{
	...
	public static class Advanced extends CrusherTile
	{
		public Advanced()
		{
	...
	public static class Elite extends CrusherTile
	{
		public Elite()
		{
	...
	public static class Ultimate extends CrusherTile
	{
		public Ultimate()
		{
