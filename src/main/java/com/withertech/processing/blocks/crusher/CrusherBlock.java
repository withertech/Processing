...
public class CrusherBlock extends AbstractFactoryMachineBlock
{
	...
	protected void interactWith(World worldIn, @Nonnull BlockPos pos, @Nonnull PlayerEntity player)
	{
		...
		if (tileentity instanceof CrusherTile && !player.getHeldItemMainhand().isItemEqual(ModItems.WRENCH.get().getDefaultInstance()))
		{
