...
public class FluidPipeTER extends TileEntityRenderer<FluidPipeTile>
{

	public static final float TANK_THICKNESS = 0.0001f;

	public FluidPipeTER(TileEntityRendererDispatcher dispatcher)
	{
		super(dispatcher);
	}

	@Override
	public void render(@Nonnull FluidPipeTile tileEntityIn, float partialTicks, @Nonnull MatrixStack matrixStackIn, @Nonnull IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
	{
	...
	private void renderFluid(@Nonnull FluidPipeTile tileEntity, MatrixStack matrix, IRenderTypeBuffer bufferIn)
	{
